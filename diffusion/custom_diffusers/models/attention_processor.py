...
class Attention(nn.Module):
    ...
    def forward(
        ...
        t1: Optional[torch.FloatTensor] = None,
...
class AttnProcessor2_0:
    ...
    def __call__(
        ...
        args = () if USE_PEFT_BACKEND else (scale,)
        query = attn.to_q(hidden_states, t1, *args)
        ...
        key = attn.to_k(encoder_hidden_states, t1, *args)
        value = attn.to_v(encoder_hidden_states, t1, *args)
        ...
        # linear proj
        hidden_states = attn.to_out[0](hidden_states, t1, *args)
        # dropout
        hidden_states = attn.to_out[1](hidden_states)
