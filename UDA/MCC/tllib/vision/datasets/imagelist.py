...
class MultipleDomainsDataset(Dataset[T_co]):
    ...
    def __init__(self, domains: Iterable[Dataset], domain_names: Iterable[str], domain_ids) -> None:
        ...
        self.domain_names = domain_names #['Ar','A_P']
        self.domain_ids = domain_ids #[0,1]
    ...
    def __getitem__(self, idx):
        ...
        # print(self.domains)
        # print(dataset_idx)
        # print(self.domain_ids)
        # print(self.domains[dataset_idx][sample_idx] + (self.domain_ids[dataset_idx],))
        # print(self.domains[dataset_idx][sample_idx])
        # print(self.domain_ids[dataset_idx],)
        # 返回的是图像,标签,domain_idx
