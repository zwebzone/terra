...
def main(args: argparse.Namespace):
    ...
    os.rename(logger.get_checkpoint_path('best'),
              logger.get_checkpoint_path(f'best_{"".join(args.source)}2{"".join(args.target)}_acc{acc1}'))
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        x_s, labels_s, domain_label = next(train_source_iter)[:3]
